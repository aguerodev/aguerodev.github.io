...
```{r}
ggsave(
  filename = "plot_wsj.jpg", dpi = 400, width = 12.5, height = 6.81
)
```


::: {.callout-tip appearance="simple"}
<mark style = 'font-size:20px'>**Visualización Avanzada con ggplot2: Creando Gráficos Impresionantes**</mark>

Si ya tienes experiencia creando gráficos con ggplot2 y buscas llevar tus habilidades al siguiente nivel, este es el curso que estabas buscando: 

+ Fecha de inicio: **{{< var curso_ggplot2.fecha >}}**.
+ Precio: **$99 USD**.
+ Modalidad: 100% online via Zoom.
+ Duración: 6 semanas, clase todos los lunes 6:00 p.m hora de Costa Rica (UTC-6).

[Leer más sobre el curso](https://tally.so/r/woy9qe){.btn .btn-outline-primary .btn role="button"} 
:::
