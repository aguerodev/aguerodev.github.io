...
+ Costa Rica/México: {{< var curso_shiny.hora_cr >}}
+ Colombia: {{< var curso_shiny.hora_col >}}
+ Argentina: {{< var curso_shiny.hora_arg >}}
...
[Inscribirte ahora]({{< var curso_shiny.url_pago >}}){.btn .btn-outline-primary .btn role="button"} 
