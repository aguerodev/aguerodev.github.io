...
+ Fecha: **{{< var curso_webscraping.fecha >}}**
+ Lecciones: {{< var curso_webscraping.dia >}}
+ Costa Rica/México: {{< var curso_webscraping.hora_cr >}} 
+ Colombia: {{< var curso_webscraping.hora_col >}} 
+ Argentina: {{< var curso_webscraping.hora_arg >}}
...
+ **Precio: {{< var curso_webscraping.precio >}}**

[Inscribirte ahora]({{< var curso_webscraping.url_pago >}}){.btn .btn-outline-primary .btn role="button"} 
