...
[Inscribirte ahora](https://tally.so/r/mYQb4N?curso=Introducci%C3%B3n+a+SQL+y+su+integraci%C3%B3n+con+R&precio=%24200%20USD&fecha_inicio=s%C3%A1bado+21+de+septiembre+de+2024&id=curso_sql_integracion_R&precio_cr=103%252C400+colones){.btn .btn-outline-primary .btn role="button"} 
